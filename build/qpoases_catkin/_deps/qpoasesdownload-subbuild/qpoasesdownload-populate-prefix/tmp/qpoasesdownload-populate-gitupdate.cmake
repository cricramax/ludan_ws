...
execute_process(
  COMMAND "/usr/bin/git" show-ref 268b2f2659604df27c82aa6e32aeddb8c1d5cc7f
  WORKING_DIRECTORY "/home/ludan/old_ws/build/qpoases_catkin/download"
...
if("${show_ref_output}" MATCHES "refs/remotes/268b2f2659604df27c82aa6e32aeddb8c1d5cc7f")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "268b2f2659604df27c82aa6e32aeddb8c1d5cc7f")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "268b2f2659604df27c82aa6e32aeddb8c1d5cc7f")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 268b2f2659604df27c82aa6e32aeddb8c1d5cc7f
  WORKING_DIRECTORY "/home/ludan/old_ws/build/qpoases_catkin/download"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/coin-or/qpOASES'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ludan/old_ws/build/qpoases_catkin/download/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ludan/old_ws/build/qpoases_catkin/download/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
