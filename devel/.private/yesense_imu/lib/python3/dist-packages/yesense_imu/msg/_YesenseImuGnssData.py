...
class YesenseImuGnssData(genpy.Message):
  _md5sum = "4ae993c6fa242f94866ceb31ffc6e7d6"
...
float32 dual_ant_baseline_len"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_H5BH2df2d3f2BfB3f().pack(_x.master.utc_time.year, _x.master.utc_time.month, _x.master.utc_time.date, _x.master.utc_time.hour, _x.master.utc_time.min, _x.master.utc_time.sec, _x.master.utc_time.ms, _x.master.location.longtidue, _x.master.location.latitude, _x.master.location.altidue, _x.master.location_error.longtidue, _x.master.location_error.latitude, _x.master.location_error.altidue, _x.master.speed, _x.master.yaw, _x.master.status, _x.master.star_cnt, _x.master.p_dop, _x.master.site_id, _x.slave.dual_ant_yaw, _x.slave.dual_ant_yaw_error, _x.slave.dual_ant_baseline_len))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.master.utc_time.year, _x.master.utc_time.month, _x.master.utc_time.date, _x.master.utc_time.hour, _x.master.utc_time.min, _x.master.utc_time.sec, _x.master.utc_time.ms, _x.master.location.longtidue, _x.master.location.latitude, _x.master.location.altidue, _x.master.location_error.longtidue, _x.master.location_error.latitude, _x.master.location_error.altidue, _x.master.speed, _x.master.yaw, _x.master.status, _x.master.star_cnt, _x.master.p_dop, _x.master.site_id, _x.slave.dual_ant_yaw, _x.slave.dual_ant_yaw_error, _x.slave.dual_ant_baseline_len,) = _get_struct_H5BH2df2d3f2BfB3f().unpack(str[start:end])
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_H5BH2df2d3f2BfB3f = None
def _get_struct_H5BH2df2d3f2BfB3f():
    global _struct_H5BH2df2d3f2BfB3f
    if _struct_H5BH2df2d3f2BfB3f is None:
        _struct_H5BH2df2d3f2BfB3f = struct.Struct("<H5BH2df2d3f2BfB3f")
    return _struct_H5BH2df2d3f2BfB3f
